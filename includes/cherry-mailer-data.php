...
/**
 * Class for Mailer data.
 *
 * @since 1.0.0
 */
class Cherry_Mailer_Data {
	...
	public function __construct() {
		 ...
		 * @since 1.0.0
		 */
		add_action( 'cherry_get_mailer', array( $this, 'the_mailer' ) );
	}
	/**
	 ...
	 * @return string
	 */
	public function get_mailer_loop( $args ) {

		// Item template.
		$template = $this->get_template_by_name( $args['template'], Cherry_Mailer_Shortcode::$name );
	...
	public function get_template_by_name( $template, $shortcode ) {
		...
		$default    = plugin_dir_path( __FILE__ ).'templates/shortcodes/mailer/default.tmpl';
